    ...
    companion object {
        ...
        fun applyAndConfigureKotlinPlugin(
            ...
            if (isMultiplatformEnabled) {
                ...
                // region Tencent Code
                // apply k2config plugin for all modules
                project.apply(plugin = "com.tencent.tmm.k2config")
                // endregion
...
private fun configureComposeCompilerPlugin(
    ...
    project.afterEvaluate {
        ...
        val compilerPluginVersion = project.property("compose.compiler.version")
        project.dependencies.add(
            COMPILER_PLUGIN_CONFIGURATION,
            "com.tencent.tmm.compose:compiler-bundle:$compilerPluginVersion"
        )
