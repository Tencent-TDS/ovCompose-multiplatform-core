...
FOUNDATION_EXTERN UIImage *_Nullable TMMNativeComposeUIImageFromSkBitmap(intptr_t skBitmapPtrAddress, int32_t cacheKey, OVComposeExperimentalConfig *experimentalConfig);
