...
- (void)setImage:(CGImageRef)imagePointer
    ...
    intptr_t tintColorPtr = (intptr_t)(__bridge void *)tintColor;
    ovmp_fastlog_log8(OVMP_FASTLOG_TAG_IMAGE,
                      OVMPFastLogPhaseImageOnClipLayerSetImageBegin,
...
- (void)targetLayerSetImage:(TMMFastTintColorImageContentLayer *)targetLayer
    ...
    ovmp_fastlog_log8(OVMP_FASTLOG_TAG_IMAGE,
                      OVMPFastLogPhaseImageOnClipLayerTargetLayerSetImageBegin,
                      taskId,
                      selfPtr,
                      (intptr_t)imagePointer,
                      srcSize.width,
    ...
    ovmp_fastlog_log6(OVMP_FASTLOG_TAG_IMAGE,
                      OVMPFastLogPhaseImageOnClipLayerTargetLayerPrintParams,
                      taskId,
                      srcOffset.x,
                      srcOffset.y,
                      dstSize.width,
