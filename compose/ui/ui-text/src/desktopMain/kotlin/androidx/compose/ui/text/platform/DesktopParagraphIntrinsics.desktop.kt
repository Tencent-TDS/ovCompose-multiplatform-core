...
internal class DesktopParagraphIntrinsics(
    ...
    private var layouter = AtomicReference(newLayouter())

    fun layouter() = layouter.getAndSet(null) ?: newLayouter()
    ...
    init {
        val para = layouter.get().layoutParagraph(Float.POSITIVE_INFINITY)
