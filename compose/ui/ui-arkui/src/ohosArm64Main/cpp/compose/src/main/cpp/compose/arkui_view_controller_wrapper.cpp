...
static napi_value InitRenderContext(napi_env env, napi_callback_info info) {
    size_t argc = 3;
    ...
    bool enableCApi;
    napi_get_value_bool(env, args[0], &enableCApi);
        
    void *controller = nullptr;
    napi_unwrap(env, thisArg, &controller);
    ArkUIViewController *typedController = reinterpret_cast<ArkUIViewController *>(controller);
        
    ArkUIViewController_initRenderContext(typedController, enableCApi, args[1], args[2]);
    return nullptr;
}
...
static napi_value initNativeInteropContainer(napi_env env, napi_callback_info info) {
    size_t argc = 3;
    napi_value args[3] = {nullptr, nullptr, nullptr};
    napi_value thisArg = nullptr;
    napi_get_cb_info(env, info, &argc, args, &thisArg, nullptr);
    ...
    napi_unwrap(env, thisArg, &controller);
    ArkUIViewController *typedController = reinterpret_cast<ArkUIViewController *>(controller);
    ArkUIViewController_setNativeInteropContainer(typedController, args[0], args[1], args[2]);
    return nullptr;
}
...
static napi_value OnAxisEvent(napi_env env, napi_callback_info info) {
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value thisArg = nullptr;
    napi_get_cb_info(env, info, &argc, args, &thisArg, nullptr);

    napi_value event = args[0];

    void *controller = nullptr;
    napi_unwrap(env, thisArg, &controller);

    ArkUIViewController *typedController = reinterpret_cast<ArkUIViewController *>(controller);
    ArkUIViewController_onAxisEvent(typedController, event);
    return nullptr;
}
...
static napi_value OnMouseEvent(napi_env env, napi_callback_info info) {
    ...
    ArkUIViewController *typedController = reinterpret_cast<ArkUIViewController *>(controller);
    ArkUIViewController_onMouseEvent(typedController, event);
    return nullptr;
}

static napi_value OnPinchEvent(napi_env env, napi_callback_info info) {
    size_t argc = 1;
    napi_value args[1] = {nullptr};
    napi_value thisArg = nullptr;
    napi_get_cb_info(env, info, &argc, args, &thisArg, nullptr);
    ...
    ArkUIViewController *typedController = reinterpret_cast<ArkUIViewController *>(controller);
    ArkUIViewController_onPinchEvent(typedController, event);
    return nullptr;
}
...
static napi_value OnKeyEvent(napi_env env, napi_callback_info info) {
    ...
    ArkUIViewController *typedController = reinterpret_cast<ArkUIViewController *>(controller);
    bool consumed = ArkUIViewController_onKeyEvent(typedController, event);
    napi_value result = nullptr;
    napi_get_boolean(env, consumed, &result);
    return result;
}
...
static napi_value UpdateDensity(napi_env env, napi_callback_info info) {
    ...
    ArkUIViewController *typedController = reinterpret_cast<ArkUIViewController *>(controller);
    ArkUIViewController_updateDensity(typedController, density);
...
static napi_value SetExtraParam(napi_env env, napi_callback_info info) {
    size_t argc = 2;
    ...
    std::string key(keyLen + 1, '\0');
    std::string value(valueLen + 1, '\0');
    napi_get_value_string_utf8(env, args[0], &key[0], keyLen + 1, &keyLen);
    napi_get_value_string_utf8(env, args[1], &value[0], valueLen + 1, &valueLen);
    key.resize(keyLen);
    ...
    napi_unwrap(env, thisArg, &controller);
    ArkUIViewController *typedController = reinterpret_cast<ArkUIViewController *>(controller);
    ArkUIViewController_setExtraParam(typedController, key, value);
    return nullptr;
}
static napi_value OnSurfaceDestroyed(napi_env env, napi_callback_info info) {
    ...
    void *controller = nullptr;
    napi_unwrap(env, thisArg, &controller);
    ArkUIViewController_onSurfaceDestroyed(reinterpret_cast<ArkUIViewController *>(controller));
    return nullptr;
}
...
static napi_value OnFrame(napi_env env, napi_callback_info info) {
    ...
    int64_t timeStamp;
    napi_get_value_int64(env, args[0], &timeStamp);

    ArkUIViewController *typedController = reinterpret_cast<ArkUIViewController *>(controller);
    ArkUIViewController_onFrame(typedController, timeStamp, timeStamp);
...
static napi_value OnIdle(napi_env env, napi_callback_info info) {
    ...
    int64_t timeLeft;
    napi_get_value_int64(env, args[0], &timeLeft);

    void *controller = nullptr;
    napi_unwrap(env, thisArg, &controller);

    ArkUIViewController *typedController = reinterpret_cast<ArkUIViewController *>(controller);
    ArkUIViewController_onIdle(typedController, timeLeft);
...
static napi_value Draw(napi_env env, napi_callback_info info) {
    ...
    ArkUIViewController *typedController = reinterpret_cast<ArkUIViewController *>(controller);
    ArkUIViewController_draw(typedController, args[0]);

    return nullptr;
}

static napi_value GetJsNode(napi_env env, napi_callback_info info) {
    size_t argc = 0;
    napi_value thisArg = nullptr;
    napi_get_cb_info(env, info, &argc, nullptr, &thisArg, nullptr);
    ...
    ArkUIViewController *typedController = reinterpret_cast<ArkUIViewController *>(controller);
    return reinterpret_cast<napi_value>(ArkUIViewController_getJsNode(typedController));
}
...
napi_value Wrapped(napi_env env, void *nativeController) {
    ...
    bindFunction(env, result, "initRenderContext", InitRenderContext);
    bindFunction(env, result, "initNativeInteropContainer", initNativeInteropContainer);
    ...
    bindFunction(env, result, "onAxisEvent", OnAxisEvent);
    bindFunction(env, result, "onMouseEvent", OnMouseEvent);
    bindFunction(env, result, "onPinchEvent", OnPinchEvent);
    bindFunction(env, result, "onKeyEvent", OnKeyEvent);
    bindFunction(env, result, "onKeyboardShow", KeyboardWillShow);
    bindFunction(env, result, "onKeyboardHide", KeyboardWillHide);
    bindFunction(env, result, "updateDensity", UpdateDensity);
    ...
    bindFunction(env, result, "setExtraParam", SetExtraParam);
    bindFunction(env, result, "onSurfaceDestroyed", OnSurfaceDestroyed);
    bindFunction(env, result, "onSurfaceChanged", OnSurfaceChanged);
    bindFunction(env, result, "onFrame", OnFrame);
    bindFunction(env, result, "onIdle", OnIdle);
    bindFunction(env, result, "draw", Draw);
    bindFunction(env, result, "getJsNode", GetJsNode);
    return result;
}
} // namespace androidx::compose::ui::arkui::utils::ArkUIViewControllerWrapper