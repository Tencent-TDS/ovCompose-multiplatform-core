...
export declare interface ArkUIViewController {
  ...
  setExtraParam(key: string, value: string): void

  onKeyEvent(event: any /*KeyEvent*/): boolean;
}
...
export declare interface InternalArkUIViewController extends ArkUIViewController {
  ...
  initRenderContext(enableCApi: boolean, importFrameMgr: any /* RenderFrameManager */, rootContent: NodeContent): void

  initNativeInteropContainer(back: any /*NodeContent*/, fore: any /*NodeContent*/ , touchable: any /*NodeContent*/): void
  ...
  onAxisEvent(event: any /*AxisEvent*/): void;

  onMouseEvent(event: any /*MouseEvent*/): void;

  onPinchEvent(event: any /*MouseEvent*/): void;
