...
void ArkUIViewController_initRenderContext(ArkUIViewController *controller, bool enableCApi, napi_value importFrameMgr, napi_value rootContent);
...
void ArkUIViewController_setExtraParam(ArkUIViewController *controller, const std::string &key, const std::string &value);
} // namespace androidx::compose::ui::arkui::utils
#endif