...
private class MultiLayerComposeSceneImpl(
    ...
    override fun processPointerInputEvent(event: PointerInputEvent) {
        when (event.eventType) {
            ...
            PointerEventType.ScrollStart -> processScroll(event)
            PointerEventType.ScrollEnd -> processScroll(event)
            PointerEventType.Pinch -> processScroll(event)
        }
    ...
    override fun processCancelledPointerInputEvent() {
        mainOwner.processCancelledPointerInputEvent()
    }
