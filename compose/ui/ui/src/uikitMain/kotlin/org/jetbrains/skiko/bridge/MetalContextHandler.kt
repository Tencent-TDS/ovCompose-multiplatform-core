...
import org.jetbrains.skiko.bridge.MetalRedrawer
import org.jetbrains.skiko.context.*

@OptIn(InternalSkikoApi::class)
internal class MetalContextHandler(layer: SkiaLayer, val metalRedrawer: MetalRedrawer) : ContextHandler(layer, layer::draw) {
