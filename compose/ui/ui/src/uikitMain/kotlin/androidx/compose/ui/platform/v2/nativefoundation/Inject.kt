...
internal fun injectForCompose() {
    ...
    /* 注入 iOS 平台的 Path */
    setNativePathFactory { NativePathImpl() }
    ...
    platformParagraphFactory = object : PlatformParagraphFactory {
        ...
        ): Paragraph? = if (EnableIosRenderLayerV2 && EnableIOSParagraph) IOSParagraph(
        ...
        override fun createParagraphIntrinsics(
            ...
            if (EnableIosRenderLayerV2 && EnableIOSParagraph) IOSParagraphIntrinsics(
                text,
                style,
                spanStyles,
                placeholders,
