...
*/
class UIKitLifecycle : LifecycleOwner {
...
fun viewControllerLifeCycle(vc: UIViewController): UIKitLifecycle? {
    return if (vc is ComposeUIViewController) {
        vc.controllerLifecycle
    } else null
}