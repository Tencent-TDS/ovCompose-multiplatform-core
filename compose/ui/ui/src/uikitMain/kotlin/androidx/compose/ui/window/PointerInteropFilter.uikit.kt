...
internal fun Modifier.pointerInteropFilter(wrappingView: UIView, highestPriorityResponseTouch: Boolean = false): Modifier {
    val filter = InteropViewCatchPointerModifier()
    filter.highestPriorityResponseTouch = highestPriorityResponseTouch
