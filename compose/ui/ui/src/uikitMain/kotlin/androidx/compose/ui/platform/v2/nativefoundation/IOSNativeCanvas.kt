...
interface IOSNativeCanvas : Canvas {
    ...
    fun drawNullTextImage(paragraphHashCode: Int, width: Int, height: Int)
    ...
    fun experimentalConfig(): ExperimentalConfig?

    fun imageFromCanvasPtr(nativeCGBitmapCanvasPtr: COpaquePointer, colorArgb: Int): Long

    fun nativePtr() : Long = 0
}