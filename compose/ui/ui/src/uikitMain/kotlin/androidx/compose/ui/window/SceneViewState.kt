...
import androidx.compose.ui.window.ComposeViewState
...
internal fun ComposeViewState<ComposeWindow, UIView>.createSceneUIViewState():SceneViewState<UIView> {
    fun createStateWithSceneBuilder(
        ...
        override val platformContext: PlatformContext by lazy {
            PlatformContextImpl(
                ...
                windowInfoProvider = { view._windowInfo },
    ...
    return if (configuration.singleLayerComposeScene) {
            ...
            object : ComposeSceneContext {
                override fun createPlatformLayer(
                    ...
                    return prepareSingleLayerComposeScene(
                        ...
                        view.doBoilerplate(this, focusable)
                        sceneView.alpha = 0.5
