...
class ArkUIView internal constructor(
    ...
    internal fun postMouseEvent(event: MouseEvent): Boolean {
        if (jsArkUIViewRef != null) {
            return jsArkUIViewRef.call("postMouseEvent", event.jsValue).asBoolean() ?: false
        }
        return false
    }

    internal fun postAxisEvent(event: AxisEvent): Boolean {
        if (jsArkUIViewRef != null) {
            return jsArkUIViewRef.call("postAxisEvent", event.jsValue).asBoolean() ?: false
        }
        return false
    }
    ...
    internal fun disposeView() {
        jsArkUIViewRef.call("disposeView")
    }
...
class ArkUIViewContainer {
    ...
    internal fun postMouseEvent(event: MouseEvent): Boolean {
        return _arkUIView?.postMouseEvent(event) ?: return false
    }

    internal fun postAxisEvent(event: AxisEvent): Boolean {
        return _arkUIView?.postAxisEvent(event) ?: return false
    }
}
