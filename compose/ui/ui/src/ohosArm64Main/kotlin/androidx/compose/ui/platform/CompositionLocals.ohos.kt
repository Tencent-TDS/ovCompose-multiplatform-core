...
val LocalFrameManager = staticCompositionLocalOf<FrameManager> {
    error("CompositionLocal frameManager not provided")
}

val LocalEnableCApi = staticCompositionLocalOf<Boolean> {
    error("CompositionLocal LocalEnableCApi not provided")
}

val LocalRootNodeId = staticCompositionLocalOf<Int> {
    error("CompositionLocal LocalRootNodeId not provided")
}
