...
import platform.arkui.NODE_TOUCH_EVENT
...
private class ArkUIViewEventManager(private val handle: ArkUI_NodeHandle) : ArkUIViewEvent {
    ...
    override var onTouch: Function1<ArkUIInputEvent, Unit>?
        by Event(NODE_TOUCH_EVENT, null)
    ...
    private fun processEvent(event: ArkUINodeEvent) {
        ...
        when (type) {
            ...
            NODE_TOUCH_EVENT-> onTouch?.invoke(OH_ArkUI_NodeEvent_GetInputEvent(event))
...
internal interface ArkUIViewEvent {
    ...
    var onTouch: Function1<ArkUIInputEvent, Unit>?
