...
import org.jetbrains.skiko.SkiaFlags
...
internal fun InternalArkUIView(
    ...
    if (SkiaFlags.isOhosArkUIBackedEnabled) {
        ArkUIViewArkUIBacked(
            name,
            modifier,
            parameter,
            update,
...
@Composable
internal fun Place(key: Int, modifier: Modifier, measurePolicy: MeasurePolicy) {
    key(key) {
