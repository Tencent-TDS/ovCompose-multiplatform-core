...
fun ExtraStorage.set(key: String, value: Any?) {
    set(UnsafeKey(key), value)
}

@ExperimentalComposeApi
fun ExtraStorage.get(key: String): Any? = get(UnsafeKey(key))
...
internal class UnsafeKey(val key: String) : Key<Any> {

    override fun equals(other: Any?): Boolean = other is UnsafeKey && other.key == key

    override fun hashCode(): Int = key.hashCode()

    override fun toString(): String = "UnsafeKey(key=$key)"
}