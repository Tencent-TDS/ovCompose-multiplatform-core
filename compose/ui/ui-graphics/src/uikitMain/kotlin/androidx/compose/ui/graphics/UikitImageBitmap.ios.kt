...
import androidx.compose.ui.uikit.utils.ovCompose_decodedData
...
class UikitImageBitmap(val uiImage: UIImage ?= null, val skiaBackedImageBitmap: ImageBitmap? = null) : ImageBitmap {
    ...
    override fun toSkiaBackedImageBitmap(): ImageBitmap?
            = skiaBackedImageBitmap ?: uiImage?.ovCompose_decodedData()?.tmmToImageBitmapFromDecoded(this.width, this.height)

    override fun toString(): String {
        return "UIKitImage(ptr:${uiImage?.CGImage})"
    }
}
