...
actual val WindowInsets.Companion.displayCutout: WindowInsets
    ...
    get() = PlatformInsetsHolder.current().displayCutout.value.windowInsets

/**
 * An insets type representing the window of an "input method",
 * for OHOS IME representing the software keyboard.
 *
 */
...
actual val WindowInsets.Companion.navigationBars: WindowInsets
    @Composable
    @OptIn(InternalComposeApi::class)
    get() = PlatformInsetsHolder.current().navigationBars.value.windowInsets
...
actual val WindowInsets.Companion.statusBars: WindowInsets
    @Composable
    @OptIn(InternalComposeApi::class)
    get() = PlatformInsetsHolder.current().statusBars.value.windowInsets
...
actual val WindowInsets.Companion.systemGestures: WindowInsets
    @Composable
    @OptIn(InternalComposeApi::class)
    get() = PlatformInsetsHolder.current().systemGestures.value.windowInsets
