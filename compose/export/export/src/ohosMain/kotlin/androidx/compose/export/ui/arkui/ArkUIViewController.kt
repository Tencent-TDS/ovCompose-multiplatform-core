...
import androidx.compose.ui.arkui._ArkUIViewController_draw
import androidx.compose.ui.arkui._ArkUIViewController_getId
import androidx.compose.ui.arkui._ArkUIViewController_getJsNode
...
import androidx.compose.ui.arkui._ArkUIViewController_updateDensity
import androidx.compose.ui.arkui._ArkUIViewController_onAxisEvent
...
import androidx.compose.ui.arkui._ArkUIViewController_onIdle
import androidx.compose.ui.arkui._ArkUIViewController_onKeyEvent
import androidx.compose.ui.arkui._ArkUIViewController_onMouseEvent
...
import androidx.compose.ui.arkui._ArkUIViewController_onPinchEvent
...
import androidx.compose.ui.arkui._ArkUIViewController_setExtraParam
...
import androidx.compose.ui.arkui._ArkUIViewController_setNativeInteropContainer
import androidx.compose.ui.arkui._ArkUIViewController_initRenderContext
import androidx.compose.ui.window.initJsRenderNodeContext as initJsRenderNodeContext2
...
fun initJsRenderNodeContext(env: napi_env, nodeConstructor: napi_value, statusModifyConstructor: napi_value, ratio: Double, fixed: Boolean) {
    initJsRenderNodeContext2(env, nodeConstructor, statusModifyConstructor, ratio, fixed)
}

@InternalExportApi
@CName("jsNodeDraw")
fun jsNodeDraw(canvas: napi_value, node: napi_value) {
    JsRenderNode.jsNodeDraw(canvas, node)
}

@InternalExportApi
@CName("mapFrameNodePos")
fun mapFrameNodePos(rootNodeId: Int, extNodeId: Int, touchX: Double, touchY: Double): napi_value {
    return ExternalRenderNode.MapFrameNodePos(rootNodeId, extNodeId, touchX, touchY)
}
...
@InternalExportApi
@CName("androidx_compose_ui_arkui_ArkUIViewController_initRenderContext")
fun _Export_ArkUIViewController_initRenderContext(
    controllerRef: COpaquePointer,
    enableCApi: Boolean,
    importFrameMgr: napi_value,
    rootContent: napi_value?
) = _ArkUIViewController_initRenderContext(controllerRef, enableCApi, importFrameMgr, rootContent)
...
@InternalExportApi
@CName("androidx_compose_ui_arkui_ArkUIViewController_setNativeInteropContainer")
fun _Export_ArkUIViewController_setNativeInteropContainer(
    controllerRef: COpaquePointer,
    backContainer: napi_value,
    foreContainer: napi_value,
    touchContainer: napi_value
) = _ArkUIViewController_setNativeInteropContainer(controllerRef, backContainer, foreContainer, touchContainer)
...
@InternalExportApi
@CName("androidx_compose_ui_arkui_ArkUIViewController_onIdle")
fun _Export_ArkUIViewController_onIdle(controllerRef: COpaquePointer, timeLeft: Long) =
    _ArkUIViewController_onIdle(controllerRef, timeLeft)

@InternalExportApi
@CName("androidx_compose_ui_arkui_ArkUIViewController_draw")
fun _Export_ArkUIViewController_draw(controllerRef: COpaquePointer, canvas: napi_value) =
    _ArkUIViewController_draw(controllerRef, canvas)

@InternalExportApi
@CName("androidx_compose_ui_arkui_ArkUIViewController_getJsNode")
fun _Export_ArkUIViewController_getJsNode(controllerRef: COpaquePointer): napi_value? =
    _ArkUIViewController_getJsNode(controllerRef)
...
@InternalExportApi
@CName("androidx_compose_ui_arkui_ArkUIViewController_onAxisEvent")
fun _Export_ArkUIViewController_onAxisEvent(controllerRef: COpaquePointer, event: napi_value) =
    _ArkUIViewController_onAxisEvent(controllerRef, event)

@InternalExportApi
@CName("androidx_compose_ui_arkui_ArkUIViewController_onKeyEvent")
fun _Export_ArkUIViewController_onKeyEvent(controllerRef: COpaquePointer, event: napi_value) =
    _ArkUIViewController_onKeyEvent(controllerRef, event)

@InternalExportApi
@CName("androidx_compose_ui_arkui_ArkUIViewController_onMouseEvent")
fun _Export_ArkUIViewController_onMouseEvent(controllerRef: COpaquePointer, event: napi_value) =
    _ArkUIViewController_onMouseEvent(controllerRef, event)

@InternalExportApi
@CName("androidx_compose_ui_arkui_ArkUIViewController_onPinchEvent")
fun _Export_ArkUIViewController_onPinchEvent(controllerRef: COpaquePointer, event: napi_value) =
    _ArkUIViewController_onPinchEvent(controllerRef, event)
...
@InternalExportApi
@CName("androidx_compose_ui_arkui_ArkUIViewController_updateDensity")
fun _Export_ArkUIViewController_updateDensity(controllerRef: COpaquePointer, density: Float) =
    _ArkUIViewController_updateDensity(controllerRef, density)
...
@InternalExportApi
@CName("androidx_compose_ui_arkui_ArkUIViewController_setExtraParam")
fun _Export_ArkUIViewController_setExtraParam(controllerRef: COpaquePointer,  key: String, value: String) =
    _ArkUIViewController_setExtraParam(controllerRef, key, value)